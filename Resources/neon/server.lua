...
function detachNeonAfterMap(playersVehicle)
	local attachedElements = getAttachedElements ( playersVehicle )
	for i,v in ipairs ( attachedElements ) do
...
addEventHandler( "onPlayerRaceWasted", getRootElement(), detachNeonAfterMap )

...
function addNeon(colour, theVehicle)
  if (colour == "Red") then
       ...
       local temp = triggerServerEvent ("attachNeon", getLocalPlayer(), theVehicle)
	   outputChatBox(boolToInt(temp))
...
function addNeonPreview(colour, theVehicle)
  if (colour == "Red") then
       setElementData( localPlayer, "neonPreview", idModel[1] )
       --outputChatBox("#00ff00Now your neon color is #ff0000Red", 255,255,255, true)
       --local theVehicle = getPedOccupiedVehicle ( localPlayer )
       detachNeon(theVehicle)
       neons(theVehicle)
  elseif (colour == "Blue") then
       setElementData( localPlayer, "neonPreview", idModel[2] )
       --outputChatBox("#00ff00Now your neon color is #0000ffBlue", 255,255,255, true)
       --local theVehicle = getPedOccupiedVehicle ( localPlayer )
       detachNeon(theVehicle)
       neons(theVehicle)
  elseif (colour == "Green") then
       setElementData( localPlayer, "neonPreview", idModel[3] )
       --outputChatBox("#00ff00Now your neon color is Green", 255,255,255, true)
       --local theVehicle = getPedOccupiedVehicle ( localPlayer )
       detachNeon(theVehicle)
       neons(theVehicle)
  elseif (colour == "Yellow") then
       setElementData( localPlayer, "neonPreview", idModel[4] )
       --outputChatBox("#00ff00Now your neon color is #ffcc00Yellow", 255,255,255, true)
       --local theVehicle = getPedOccupiedVehicle ( localPlayer )
       detachNeon(theVehicle)
       neons(theVehicle)
  elseif (colour == "Pink") then
       setElementData( localPlayer, "neonPreview", idModel[5] )
       --outputChatBox("#00ff00Now your neon color is #f754e1Pink", 255,255,255, true)
       --local theVehicle = getPedOccupiedVehicle ( localPlayer )
       detachNeon(theVehicle)
       neons(theVehicle)
  elseif (colour == "White") then
       setElementData( localPlayer, "neonPreview", idModel[6] )
       --outputChatBox("#00ff00Now your neon color is #ffffffWhite", 255,255,255, true)
       --local theVehicle = getPedOccupiedVehicle ( localPlayer )
       detachNeon(theVehicle)
       neons(theVehicle)
  elseif (colour == "None") then
       setElementData( localPlayer, "neonPreview", 0 )
       --outputChatBox("#00ff00Your neon successfully reseted", 255,255,255, true)
       --local theVehicle = getPedOccupiedVehicle ( localPlayer )
       detachNeon(theVehicle)
  end
...
function replaceTXD() 
	txd = engineLoadTXD ( "neon/models/MatTextures.txd" )
	...
	col = engineLoadCOL("neon/models/RedNeonTube1.col")
	engineReplaceCOL(col, idModel[1])
	col = engineLoadCOL("neon/models/BlueNeonTube1.col")
	engineReplaceCOL(col, idModel[2])
	col = engineLoadCOL("neon/models/GreenNeonTube1.col")
	engineReplaceCOL(col, idModel[3])
	col = engineLoadCOL("neon/models/YellowNeonTube1.col")
	engineReplaceCOL(col, idModel[4])
	col = engineLoadCOL("neon/models/PinkNeonTube1.col")
	engineReplaceCOL(col, idModel[5])
	col = engineLoadCOL("neon/models/WhiteNeonTube1.col")
	engineReplaceCOL(col, idModel[6])

	dff = engineLoadDFF ( "neon/models/RedNeonTube1.dff", idModel[1] )
	engineReplaceModel ( dff, idModel[1] ) 
	dff = engineLoadDFF ( "neon/models/BlueNeonTube1.dff", idModel[2] )
	engineReplaceModel ( dff, idModel[2] ) 
	dff = engineLoadDFF ( "neon/models/GreenNeonTube1.dff", idModel[3] )
	engineReplaceModel ( dff, idModel[3] ) 
	dff = engineLoadDFF ( "neon/models/YellowNeonTube1.dff", idModel[4] )
	engineReplaceModel ( dff, idModel[4] ) 
	dff = engineLoadDFF ( "neon/models/PinkNeonTube1.dff", idModel[5] )
	engineReplaceModel ( dff, idModel[5] ) 
	dff = engineLoadDFF ( "neon/models/WhiteNeonTube1.dff", idModel[6] )
...
--preview client versie van de server file
local vehicles =
{
    [ 400 ] = true,
    [ 401 ] = true,
...
function neons (theVehicle)
	local NeonType = getElementData(localPlayer, "neonPreview")
...
function detachNeon( theVehicle )
    ...
    for i,v in ipairs ( attachedElements ) do
		if isNeonObject(getElementModel(v)) then
			detachElements ( v, playersVehicle )
			destroyElement ( v )
		end
	end
end

function isNeonObject(id)
	for i,v in ipairs ( idModel ) do
		if v == id then
			return true
		end
	end
